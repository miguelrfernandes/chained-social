...
if [ -n "$CODESPACES" ]; then
    ...
    echo "Frontend: ${BASE_URL}/?canisterId=${FRONTEND_ID}"
    ...
    echo ""
    echo "🔧 Alternative Frontend URLs (try these if the above doesn't work):"
    echo "Frontend (Alt 1): ${BASE_URL}/"
    echo "Frontend (Alt 2): ${BASE_URL}/?canisterId=${FRONTEND_ID}"
    echo "Frontend (Alt 3): http://127.0.0.1:4943/?canisterId=${FRONTEND_ID}"
else
